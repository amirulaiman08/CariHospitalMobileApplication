...
import com.example.groupproject.databinding.ActivityNearbyHospitalBinding;
...
public class NearbyHospital extends FragmentActivity implements OnMapReadyCallback {
    ...
    private ActivityNearbyHospitalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNearbyHospitalBinding.inflate(getLayoutInflater());
        ...
        hospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                stringBuilder.append("&key="+"AIzaSyDAXim4gD3duSxr5OrQGyJaJtkrfP2tQew" );
